...
-   Проинтерпретируйте результат. Как вы думаете, почему он именно такой? Если у вас есть гипотеза,           проиллюстрируйте ее еще одним графиком (или графиками).
...
data %>% 
  ...
  ggplot(aes(x = fct_reorder( fct_recode(bloodStatus,
                                         "Полукровки" = "half-blood", 
                                         "Грязнокровки" = "muggle-born", 
                                         "Чистокровки" = "pure-blood" ), 
                              meanPotionsExam, .desc = TRUE), meanPotionsExam, 
  ...
  scale_colour_manual(values = c("half-blood" = "lightsalmon2", "muggle-born" = "slategrey", 
                               "pure-blood" = "gold2"), 
                      labels = c("half-blood" = "Полукровки", "muggle-born" = "Грязнокровки", 
                               "pure-blood" = "Чистокровки")
                      )+
...
Cравнить все экзамены - где-то хороша грязь, а где-то нет
...
```{r fig.height=15, fig.width=15}
  ...
  group_by(bloodStatus) %>% 
  summarise(meanPotionsExam = signif(mean(score), 3),
            lower_Bound = quantile(score, 0.025), 
            upper_Bound = quantile(score, 0.975)) 
